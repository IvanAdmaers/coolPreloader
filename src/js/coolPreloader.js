class coolPreloader {
  ...
  imageLoaded () {
    ...
    this.imagesLoadedCount ? this.preloaderPercent.textContent = `${percent}%` : this.preloaderPercent.textContent = '100%';
